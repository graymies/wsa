...
! function(e, t) {
    ...
    function k(e, t, n, i) {
        ...
        if (f && (o = p(t, e[0].ownerDocument, !1, e, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            ...
            if (a)
                for (u = s[s.length - 1].ownerDocument, re.map(s, b), d = 0; a > d; d++) l = s[d], Pe.test(l.type || "") && !Ce.access(l, "globalEval") && re.contains(u, l) && (l.src ? re._evalUrl && re._evalUrl(l.src) : re.globalEval(l.textContent.replace(Ue, "")))
        }
        return e
    }
    ...
    var ce = function(e) {
            ...
            if (!i && ((t ? t.ownerDocument || t : F) !== O && D(t), t = t || O, q)) {
                if (11 !== v && (u = me.exec(e)))
                    ...
                    if (1 !== v) h = t, f = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, "\\$&") : t.setAttribute("id", a = I), d = C(e), r = d.length, l = pe.test(a) ? "#" + a : "[id='" + a + "']"; r--;) d[r] = l + " " + p(d[r]);
            ...
            var o = n.length > 0,
                ...
                s = function(i, s, a, l, u) {
                    var c, d, p, f = 0,
                        ...
                        x = b.length;
                    for (u && (A = s === O || s || u); h !== x && null != (c = b[h]); h++) {
                        if (r && c) {
                            for (d = 0, s || c.ownerDocument === O || (D(c), a = !q); p = e[d++];)
                                if (p(c, s || O, a)) {
                                    l.push(c);
                                    break
                                } u && (M = w)
        ...
        var w, x, k, T, S, C, $, E, A, j, N, D, O, H, q, P, L, _, z, I = "sizzle" + 1 * new Date,
            F = e.document,
            M = 0,
            R = 0,
            W = n(),
        ...
        x = t.support = {}, S = t.isXML = function(e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, H = O.documentElement, q = !S(O), (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), x.attributes = o(function(e) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                for (p = g, d = p[I] || (p[I] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], f = u[0] === M && u[1], b = f && u[2], p = f && g.childNodes[f]; p = ++f && p && p[v] || (b = f = 0) || h.pop();)
                                    if (1 === p.nodeType && ++b && p === t) {
                                        c[e] = [M, f, b];
                                        break
                                    }
                            } else if (y && (p = t, d = p[I] || (p[I] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], f = u[0] === M && u[1], b = f), b === !1)
                                for (;
                                    (p = ++f && p && p[v] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++b || (y && (d = p[I] || (p[I] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), c[e] = [M, b]), p !== t)););
        ...
        return d.prototype = k.filters = k.pseudos, k.setFilters = new d, C = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = fe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !k.relative[a = s.type]);)
                    if ((l = k.find[a]) && (i = l(s.matches[0].replace(we, xe), ye.test(r[0].type) && c(t.parentNode) || t))) {
    ...
    re.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (r = r || c(e), s = s || c(a), i = 0, o = r.length; o > i; i++) w(r[i], s[i]);
                else w(e, a);
    ...
    re.extend({
        ...
        re.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var o, r = i && Qe(e),
                    s = i && N(e, t, i, "border-box" === re.css(e, "boxSizing", !1, r), r);
    ...
    At.href = gt.href, re.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                var u, d, y, b, x, T = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), o = void 0, s = a || "", k.readyState = t > 0 ? 4 : 0, u = t >= 200 && 300 > t || 304 === t, i && (b = B(p, k, i)), b = U(p, b, k, u), u ? (p.ifModified && (x = k.getResponseHeader("Last-Modified"), x && (re.lastModified[r] = x), x = k.getResponseHeader("etag"), x && (re.etag[r] = x)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = b.state, d = b.data, y = b.error, u = !y)) : (y = T, !t && T || (T = "error", 0 > t && (t = 0))), k.status = t, k.statusText = (n || T) + "", u ? v.resolveWith(f, [d, T, k]) : v.rejectWith(f, [k, T, y]), k.statusCode(m), m = void 0, c && h.trigger(u ? "ajaxSuccess" : "ajaxError", [k, p, u ? d : y]), g.fireWith(f, [k, T]), c && (h.trigger("ajaxComplete", [k, p]), --re.active || re.event.trigger("ajaxStop")))
            }
            ...
            if (v.promise(k).complete = g.add, k.success = k.done, k.error = k.fail, p.url = ((t || p.url || gt.href) + "").replace(bt, "").replace(St, gt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = re.trim(p.dataType || "*").toLowerCase().match(xe) || [""], null == p.crossDomain) {
                u = G.createElement("a");
                try {
            ...
            c = re.event && p.global, c && 0 === re.active++ && re.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Tt.test(p.type), r = p.url, p.hasContent || (p.data && (r = p.url += (yt.test(r) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = wt.test(r) ? r.replace(wt, "$1_=" + mt++) : r + (yt.test(r) ? "&" : "?") + "_=" + mt++)), p.ifModified && (re.lastModified[r] && k.setRequestHeader("If-Modified-Since", re.lastModified[r]), re.etag[r] && k.setRequestHeader("If-None-Match", re.etag[r])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && k.setRequestHeader("Content-Type", p.contentType), k.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Et + "; q=0.01" : "") : p.accepts["*"]);
...
function() {
    ...
    function b(e, t, n, i, o) {
        return e === t || (null == e || null == t || !J(e) && !Z(t) ? e !== e && t !== t : w(e, t, b, n, i, o))
    }
    ...
    function x(e) {
        var t = typeof e;
        return "function" == t ? e : null == e ? se : ("object" == t ? S : $)(e)
    }
    ...
    function Y(e) {
        return Z(e) && V(e) && Se.call(e, "callee") && (!De.call(e, "callee") || "[object Arguments]" == $e.call(e))
    }
    ...
    var le, ue = 1 / 0,
        ...
        xe = r(ve && ge && "object" == typeof global && global) || be !== (we && we.window) && be || ye || we || Function("return this")(),
        ke = Array.prototype,
        Te = Object.prototype,
    ...
    }, (be || ye || {})._ = u, "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
        return u
    ...
    ! function(e, t, n) {
        ...
        var y = [],
            ...
            x = function() {};
        x.prototype = w, x = new x, x.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
        ...
        x._q.unshift(function() {
            delete A.style
        }), w.testAllProps = g, w.testAllProps = m, x.addTest("flexbox", m("flexBasis", "1px", !0)), x.addTest("csstransforms", function() {
